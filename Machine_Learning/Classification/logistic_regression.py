...
We will build a model to see if a user is going to buy an SUV or not
based on age and estimated salary. So the matrix of features is only going to include 
two feature age and salary the dependent variable y will have one feature if purchase
was made
