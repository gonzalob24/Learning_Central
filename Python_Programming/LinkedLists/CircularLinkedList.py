...
class CircularLinkedList(object):
    ...
    def insert_after(self, data, x):
        ...
        while True:
            ...
            if p == self.last.link:  # If this is true then we have gone around the circle once
                break
...
while True:
    ...
    if option == 1:
        ...
        data1 = int(input("Enter the element to be inserted: "))
        where = int(input("Enter the element after which to insert: "))
        list1.insert_after(data1, where)
    elif option == 6:
