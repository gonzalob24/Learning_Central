# I am just playing arround with classes and created new methods for the Point class
class Point:
    def __init__(self, x, y):  # Constructor with two parameters
        self.x = x
        self.y = y

    def getX(self):             # Gets and returns the value of x
        return self.x

    def getY(self):             # Gets and returns the value of y
        return self.y

    def __str__(self):          # Override how the string function is behaving
