...
public class IntList
{
    ...
    //returns size using iteration
    public int iterationSize()
    {
        IntList p = this;  // p is a temporary pointer
        int totalSize = 0;
        while (p != null)
        {
            totalSize++;
    ...
    // Method that returs the ith item of the list
    ...
    //a different way to get the ith item of the list using recursion
    ...
    /**
     * add element to front of the IntList
     */
