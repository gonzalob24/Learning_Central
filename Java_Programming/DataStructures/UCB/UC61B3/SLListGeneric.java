package UCB.UC61B3;
import UCB.List61B3.List61B;
import UCB.UC61B0.IntNode;

/** Singly linked list*/
public class SLListGeneric<Blorp> implements List61B<Blorp> {
    ...
    public static void main(String[] args) {
        ...
        SLListGeneric L = new SLListGeneric();
        L.addLast(20);
